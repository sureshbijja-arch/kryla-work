    ...
    <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center px-4">
      <div className="w-full max-w-md text-center">
        ...
        <div className="bg-white border border-[#E5E5E5] border-t-0 rounded-b-2xl px-7 py-10">
          ...
          <p className="text-sm text-[#666] mb-6 leading-relaxed">Your presence is live on Kryla. Share it and your first business will come.</p>
          <a href={`https://${slug}.kryla.work`} target="_blank" rel="noopener noreferrer"
            ...
            <span className="text-[#F5A623]">kryla.work/</span><span>{slug}</span><span className="text-white/40 text-xs ml-1">↗</span>
          </a>
          <div className="flex gap-2.5 justify-center flex-wrap">
            <Link href="/dashboard" className="bg-[#0D0D0D] text-white rounded-xl px-5 py-2.5 text-sm font-semibold hover:bg-[#222] transition-colors">
              Go to your space →
            </Link>
            <a href={`https://wa.me/?text=Hi! I just set up my presence on Kryla — find me at https://${slug}.kryla.work`}
          ...
          <p className="text-xs text-[#999] mt-6 leading-relaxed">A welcome message from a fellow Kryla member in your city is on its way 👋</p>
        </div>
        <p className="text-center text-xs text-[#999] mt-4">Need anything? Ask us on WhatsApp — we're always there.</p>
      </div>
    </div>
  )
}
