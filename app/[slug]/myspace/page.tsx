...
export default async function SlugMySpacePage({ params }: Props) {
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-6">
        <div className="max-w-sm text-center">
          ...
          <a href={SITE_URL} className="text-sm font-semibold text-[#F5A623] hover:underline">
            Go to kryla.work →
          </a>
        </div>
      </div>
  ...
  // If the URL slug doesn't match this user's slug, redirect to their own dashboard
  if (provider.slug !== params.slug) {
